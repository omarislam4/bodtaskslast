  ...
  return (
    <div className="min-h-screen flex bg-background">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary relative overflow-hidden flex-col items-center justify-center gap-6 p-12">
        ...
        <div
          className="absolute inset-0 bg-linear-to-br from-primary via-primary to-primary/80 pointer-events-none"
          style={{ zIndex: -1 }}
        />
      </div>
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-8 lg:hidden">
            <img
              src={bodLogo}
              alt="BOD"
              className="w-9 h-9 rounded-xl object-contain bg-primary/10 p-1"
            />
