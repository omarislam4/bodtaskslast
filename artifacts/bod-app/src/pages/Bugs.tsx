            ...
            >
              ...
              <form onSubmit={handleCreate} className="space-y-4">
                ...
                <div className="flex gap-3 justify-end pt-2">
                  ...
                  <button
                    type="submit"
                    disabled={createBug.isPending || !form.spaceId}
      ...
      <div className="bg-card border border-border rounded-xl p-4 mb-5 shadow-sm space-y-3">
        <div className="relative">
          ...
          <input
            ...
            className="w-full ps-9 pe-3 py-2 text-sm bg-background border border-input rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/30"
          />
        </div>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {severityOptionsSelect.map((s) => (
            <button
              ...
              className={cn(
                "px-3 py-1 text-xs font-medium rounded-lg transition-all border border-transparent",
                severityFilter === s
                  ? s === "all"
                    ? "bg-primary text-primary-foreground"
                    : `${severityConfig[s].className}`
                  : "bg-muted text-muted-foreground hover:text-foreground",
              )}
            >
              {s === "all" ? t.all : severityConfig[s].label}
            </button>
          ))}
        </div>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {statusOptionsSelect.map((s) => (
            ...
            >
              {s === "all" ? t.all : statusConfig[s].label}
            </button>
          ))}
        </div>
