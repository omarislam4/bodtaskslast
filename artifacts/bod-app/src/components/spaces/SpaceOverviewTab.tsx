...
import { statusOptions, taskStatusConfig } from "@/config/status-config";
    ...
    >
      <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 mb-6">
        {[
          ...
          },
          {
            label: t.notAssigned,
            value: tasks.filter(
              (tk) => !tk.assigneeIds || tk.assigneeIds.length === 0,
            ).length,
      ...
      <div className="grid sm:grid-cols-2 gap-4 mb-6">
        ...
        <div className="bg-card border border-border rounded-xl p-4 sm:p-5 shadow-sm">
            ...
            .map((task) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={cn(
                      "text-xs font-medium shrink-0 ms-2",
                      days <= 2 ? "text-red-500" : "text-muted-foreground",
                    )}
                  >
                    {days === 0
                      ? t.today
          ...
          {tasks.filter((task) => task.deadline && task.status !== "done")
            .length === 0 && (
